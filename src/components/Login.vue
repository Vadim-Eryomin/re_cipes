        ...
        <FlexboxLayout class="flex-col justify-center items-stretch h-full">
          <GridLayout rows="auto" columns="*" class="bg-[#FFFFFF] rounded-2xl mx-4 py-11">
            <StackLayout class="px-4">
              <Image src="~/assets/logoMini.png" width="70" height="70" class="self-center pt-4 mb-5" />
              ...
              <StackLayout class="self-center w-full mb-5">
                <Label class="text-[#969696] font-inter font-semibold text-base text-center"
                  text="Войдите в свой аккаунт для работы с reCipes" textWrap="true" />
              </StackLayout>
              ...
              <StackLayout>
                <GridLayout rows="auto" columns="19, *" class="bg-[#E9E9ED] rounded-2xl px-4 py-5 mb-4" :class="[
                  'border-5',
                ...
                <GridLayout rows="auto" columns="16, *" class="bg-[#E9E9ED] rounded-2xl px-4 py-5 mb-4" :class="[
                  'border-5',
                  ...
                  <TextField col="1" v-model="form.password" hint="Пароль"
                    class="placeholder-[#969696] bg-transparent text-sm font-inter font-semibold ml-4"
                    :class="form.password ? 'text-[#1E1D2E]' : 'text-[#969696]'" @focus="focusedField = 'password'"
                    @blur="focusedField = null" autocorrect="false" autocapitalizationType="none" />
                </GridLayout>

                <Label text="Забыли пароль?" class="text-[#969696] font-inter font-semibold text-sm text-right mb-4"
                ...
                <Button :text="isLoading ? 'Вход...' : 'Войти'"
                  ...
                  :isEnabled="isFormValid && !isLoading" textTransform="none" @tap="onLogin" />

                <FlexboxLayout class="flex-row justify-center items-center">
                  <Label text="Нет аккаунта?" class="text-[#969696] font-inter font-semibold text-sm" />
                  <Label text="Зарегистрироваться" class="text-[#F25C05] font-inter font-semibold text-sm ml-8"
